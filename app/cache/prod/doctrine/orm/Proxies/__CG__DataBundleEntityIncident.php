 ...
 */
class Incident extends \DataBundle\Entity\Incident implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'id', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'title', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'text', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'statusCode', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'occurrence', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'application', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'trace', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'message', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'class', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'uri', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'ip', '' . "\0" . 'DataBundle\\Entity\\Incident' . "\0" . 'heartbeat'];
        }
