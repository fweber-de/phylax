...
class Application
{
     ...
     * Add incident.
     *
     * @param \Ligneus\DataBundle\Entity\Incident $incident
     *
     * @return Application
     */
    public function addIncident(\Ligneus\DataBundle\Entity\Incident $incident)
    {
     ...
     * @param \Ligneus\DataBundle\Entity\Incident $incident
     */
    public function removeIncident(\Ligneus\DataBundle\Entity\Incident $incident)
    {
     ...
     * @return Application
     */
    public function addHeartbeat(\Ligneus\DataBundle\Entity\Heartbeat $heartbeat)
    {
     ...
     * @param \Ligneus\DataBundle\Entity\Heartbeat $heartbeat
     */
    public function removeHeartbeat(\Ligneus\DataBundle\Entity\Heartbeat $heartbeat)
    {
