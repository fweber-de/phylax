...
namespace Ligneus\TrackerBundle\Controller;

use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;
use Seld\JsonLint\JsonParser;
use Ligneus\DataBundle\Entity\Heartbeat;
...
class PingController extends Controller
{
    public function heartbeatAction(Request $request)
    {
        ...
        /* @var $app \Ligneus\DataBundle\Entity\Application */
        $app = $this->getDoctrine()->getRepository('LigneusDataBundle:Application')->findOneByAppkey($parsed->appkey);
        ...
        $heartbeat = $this->getDoctrine()->getRepository('LigneusDataBundle:Heartbeat')->getOneByIpAndApp($parsed->ip, $app);
        $persist = false;
