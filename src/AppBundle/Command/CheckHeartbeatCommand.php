...
class CheckHeartbeatCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $context->setHost($this->getContainer()->getParameter('exc.console_host'));
        ...
        $applications = $this->getContainer()->get('doctrine')->getRepository('DataBundle:Application')->findAll();
