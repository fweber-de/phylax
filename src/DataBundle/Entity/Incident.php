 ...
 *
 * @ORM\Table("incident")
 * @ORM\Entity(repositoryClass="DataBundle\Entity\IncidentRepository")
 */
class Incident
{
    /**
     ...
     * @return Incident
     */
    public function setHeartbeat(\DataBundle\Entity\Heartbeat $heartbeat = null)
    {
     ...
     * Get heartbeat.
     *
     * @return \DataBundle\Entity\Heartbeat
     */
